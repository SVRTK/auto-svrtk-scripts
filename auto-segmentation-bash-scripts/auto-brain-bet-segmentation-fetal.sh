...
echo "-----------------------------------------------------------------------------"
echo
echo "BET for fetal MRI (KCL): auto segmentation of fetal 3D SVR T2w brain recons"
echo
echo "-----------------------------------------------------------------------------"
echo "-----------------------------------------------------------------------------"
echo
...
if [[ $# -ne 2 ]] ; then
    echo "Usage: bash /home/auto-proc-svrtk/auto-brain-bet-segmentation-fetal.sh"
...
echo "-----------------------------------------------------------------------------"
echo
echo "3D BRAIN BET SEGMENTATION OF 3D SVR T2W BRAIN RECONS..."
echo
